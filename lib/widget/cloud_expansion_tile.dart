...
class CloudExpansionTile extends StatefulWidget {
  /// Creates a single-line [ListTile] with an expansion arrow icon that expands or collapses
  /// the tile to reveal or hide the [children]. The [initiallyExpanded] property must
  /// be non-null.
  const CloudExpansionTile({
    super.key,
    this.leading,
    required this.title,
    this.visualDensity,
  ...
  @override
  State<CloudExpansionTile> createState() => _ExpansionTileState();
}

class _ExpansionTileState extends State<CloudExpansionTile> with SingleTickerProviderStateMixin {
          ...
          ListTileTheme.merge(
            ...
            child: ListTile(
              ...
              contentPadding: widget.tilePadding ?? expansionTileTheme.tilePadding,
                minLeadingWidth:0,
              leading: widget.trailing ?? _buildTrailingIcon(context),
              title: widget.title,
