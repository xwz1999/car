...
part 'Individual_consignment_info_model.g.dart';

@JsonSerializable()
class IndividualConsignmentInfoModel extends Equatable {
  final int id;
  final int status;
  final Car car;
  ...
  factory IndividualConsignmentInfoModel.fromJson(Map<String, dynamic> json) =>
      _$IndividualConsignmentInfoModelFromJson(json);

  const IndividualConsignmentInfoModel({
    required this.id,
