...
class ImmediateWithdrawalPage extends StatefulWidget {
  const ImmediateWithdrawalPage({super.key});

  @override
  State<ImmediateWithdrawalPage> createState() =>
      _ImmediateWithdrawalPageState();
}
...
class _ImmediateWithdrawalPageState extends State<ImmediateWithdrawalPage> {
  @override
