                  ...
                  if (!genderText.isNotEmpty) {
                    ...
                    if (!phoneText.isNotEmpty) {
                      ...
                      if (!matched) {
                        ...
                        if (!storeidText.isNotEmpty) {
                          BotToast.showText(text: '请选择手机架构');
                        } else {
                          if (!permissions1.isNotEmpty) {
...
//权限分配   ///权限配置 销售提成
  ...
  _refresh() async {
    zhi = await Business.getStaffadd(nameText, int.parse(genderText), phoneText,
        int.parse(storeidText), int.parse(permissions1), commissionText);
  }
}
