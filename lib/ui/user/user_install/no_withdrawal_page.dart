...
class NoWithdrawalPage extends StatefulWidget {
  const NoWithdrawalPage({super.key});

  @override
  _NoWithdrawalPageState createState() => _NoWithdrawalPageState();
}

class _NoWithdrawalPageState extends State<NoWithdrawalPage> {
  List<dynamic>? data;
