          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                getContentItem('成交价',widget.contractModel.value.carModel!.price,endText: '元',isSpecial:true),

                getContentItem('定金',widget.contractModel.value.carAmountModel!.deposit,endText: '元',isSpecial:true,topIcon: false),

                getContentItem('首付',widget.contractModel.value.carAmountModel!.downPayment,endText: '元',isSpecial:true,topIcon: false),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                getContentItem('客户',widget.contractModel.value.customerModel!.nickname, ),

                getContentItem('手机号',widget.contractModel.value.phone??'', isSpecial:true),

                getContentItem('姓名',widget.contractModel.value.name??'', ),

                getContentItem('身份证号',widget.contractModel.value.cardNo??'', isSpecial:true),

                getContentItem('客户来源',widget.contractModel.value.origin??'',),

                getContentItem('地址',widget.contractModel.value.address??'',),

                getContentItem('所在地',widget.contractModel.value.location??'',topIcon: false),

                getContentItem('付款人',widget.contractModel.value.payer??'',),

                getContentItem('开户行',widget.contractModel.value.bank??'',),

                getContentItem('银行卡号',widget.contractModel.value.bankCard??'',),

                getContentItem('备注描述',widget.contractModel.value.remarks??'',topIcon: false),
                30.hb,
                    ...
                    Alert.show(
                        ...
                        NormalContentDialog(
                          ...
                          await  CarFunc.addSale(CarSaleContractModel(
                              carId: widget.contractModel.value.carModel!.id,
                              customerId: widget.contractModel.value.customerModel!.id,
                              phone: widget.contractModel.value.phone??'',
                              idCard:widget.contractModel.value.name?? '',
                              address: widget.contractModel.value.address?? '',
                              openBank: widget.contractModel.value.bank?? '',
                              bankCard: widget.contractModel.value.bankCard?? '',
                              remark: widget.contractModel.value.remarks?? '',
                              name: widget.contractModel.value.name??''
                            )).then((value) {
                              if(value){
