...
class _NewCarsDetailPageState extends State<NewCarsDetailPage>
  ...
  _refresh() async {
    ...
    for(var item in carInfoModel!.carInfo.carPhotos){
      photos.add(CarPhotos(photo: item.photo,text: item.text));
    }
    ...
    pushPhotoModel = PushPhotoModel(carPhotos: photos,interiorPhotos: interiorPhotos,defectPhotos: defectPhotos);
    setState(() {});
  }
