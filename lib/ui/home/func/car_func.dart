...
class CarFunc{
  ...
  static Future<List<SortBrandModel>> getBrandList() async {
    ...
    if (baseList.code!=0) {
      ...
      return baseList.nullSafetyList.map((e) => SortBrandModel.fromJson(e)).toList();
    }
  }
  ...
  static Future<List<CarListModel>> getCarList(int page,int size) async {
    ...
    if (baseList.code!=0) {
      ...
      return baseList.nullSafetyList.map((e) => CarListModel.fromJson(e)).toList();
    }
  }
...
///车辆详情
  ...
  ///发起寄卖合同
  static Future<bool> addConsignment(ConsignmentContractModel contractModel) async {
