...
class _PurchaseInfoPageState extends State<PurchaseInfoPage> {
  ...
  @override
  void initState() {
    HiveStore.carBox?.get('acquisitionSecond') != null ? _reg() : () {};
    super.initState();
  }
          ...
          child: IconButton(
            onPressed: () {
              ...
              PurchaseInfoModel purchaseInfo = PurchaseInfoModel(
                ...
                downPaymentAmount: depositAmountController.text,
                downPaymentNum: downPaymentNumController.text,
                balanceAmountBackup: balanceAmountBackupController.text,
                balanceAmountBackupNum: balanceAmountBackupNumController.text,
                deliveryDate:
